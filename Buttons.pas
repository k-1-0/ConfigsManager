...
//                                                                            //
                                                                              //
  {$DEFINE 2D_FLAT}             // Плоский бордюр Flat SpeedButton
  {.$DEFINE HIGHLIGHT_PRESSED}   // Подсвечивать SpeedButton в момент нажатия
                                                                              //
////////////////////////////////////////////////////////////////////////////////
...
uses Consts, SysUtils, ActnList, ImgList, Utils;
...
begin
  ...
  begin
    if ((FState in [bsDown, bsExclusive]) or
      ...
      (csDesigning in ComponentState)) AND (NOT LockSpeedButtons) then
    {$IFDEF 2D_FLAT}
      begin
      DrawEdge(Canvas.Handle, PaintRect, BDR_SUNKENOUTER,
        FillStyles[Transparent] OR BF_TOPLEFT);
      DrawEdge(Canvas.Handle, PaintRect, BDR_RAISEDINNER,
        FillStyles[Transparent] OR BF_BOTTOMRIGHT);
      end
    {$ELSE}
